...
The Katy Freeway in Houston is a perfect example of how just [building more of the same thing doesn't always solve the problem](https://www.youtube.com/watch?v=qrV_OrQMiBE). That highway is the largest in the US with twelve lanes in each direction, but it *still* manages to suffer traffic jams, because adding more lanes to a highway doesn't solve traffic.
